  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "absolute top-[10%] left-[15%] text-[60px] opacity-10 -rotate-12 select-none pointer-events-none", children: "\u{1F99E}" }),
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-[10%] right-[10%] text-[80px] opacity-10 rotate-12 select-none pointer-events-none", children: "\u{1F30A}" }),
        /* @__PURE__ */ jsxs(
          Link,
          {
            to: routes.home,
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center mb-6", children: [
                ...
                /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-white mb-1", children: "Daftar Akun Baru" }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-white/60 text-center", children: "Bergabung dengan ekosistem perikanan sirkular Aceh." })
              ] }),
              /* @__PURE__ */ jsxs("form", { onSubmit: handleRegister, className: "flex flex-col gap-4", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex bg-white/5 rounded-xl p-1 border border-white/10", children: [
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      type: "button",
                      onClick: () => setRole("buyer"),
                      className: `flex-1 py-2 text-xs font-semibold rounded-lg transition-all ${role === "buyer" ? "bg-[#3CC8D8] text-white shadow-md" : "text-white/50 hover:text-white/80"}`,
                      children: "Pembeli"
                    }
                  ),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      ...
                      className: `flex-1 py-2 text-xs font-semibold rounded-lg transition-all ${role === "seller" ? "bg-[#3CC8D8] text-white shadow-md" : "text-white/50 hover:text-white/80"}`,
                      children: "Nelayan / Pengepul"
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("label", { className: "block text-xs font-medium text-white/70 mb-1.5 ml-1", children: "Nama Lengkap" }),
                  /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                    /* @__PURE__ */ jsx("div", { className: "absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none", children: /* @__PURE__ */ jsx(User, { size: 16, className: "text-white/40" }) }),
                    /* @__PURE__ */ jsx(
                      "input",
                      {
                        type: "text",
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("label", { className: "block text-xs font-medium text-white/70 mb-1.5 ml-1", children: "Konfirmasi Password" }),
                  /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                    /* @__PURE__ */ jsx("div", { className: "absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none", children: /* @__PURE__ */ jsx(Lock, { size: 16, className: "text-white/40" }) }),
                    /* @__PURE__ */ jsx(
                      "input",
              ...
              /* @__PURE__ */ jsxs("p", { className: "mt-6 text-center text-xs text-white/50", children: [
                "Sudah punya akun?",
                " ",
                /* @__PURE__ */ jsx(Link, { to: routes.login, className: "text-[#3CC8D8] font-semibold hover:text-[#54D9E8] transition-colors", children: "Masuk di sini" })
              ] })
            ]
          }
        )
