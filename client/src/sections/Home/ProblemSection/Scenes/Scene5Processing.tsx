  ...
  return (
    <div className="relative w-28 h-28 flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span className="text-xl font-black text-white/90 leading-none">{wastePercent}%</span>
        <span className="text-[7px] uppercase tracking-[0.15em] text-white/40 font-semibold mt-0.5">Terbuang</span>
      </div>
    </div>
  );
}
...
export default function Scene5Processing({ scrollYProgress }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[35%] left-[48%] w-[500px] h-[500px] rounded-full bg-rose-500/[0.04] blur-[150px] -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute top-[65%] left-[35%] w-[300px] h-[300px] rounded-full bg-amber-500/[0.03] blur-[120px]" />
      <div className="absolute top-[30%] right-[20%] w-[250px] h-[250px] rounded-full bg-teal-500/[0.04] blur-[100px]" />
      ...
      >
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.06] border border-white/10 backdrop-blur-sm">
          ...
          <span className="text-[10px] tracking-[0.2em] uppercase text-white/60 font-semibold">
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="mt-1 px-3 py-1.5 rounded-lg bg-amber-500/10 border border-amber-500/20">
            <span className="text-[9px] text-amber-300/70 font-semibold tracking-wide">
